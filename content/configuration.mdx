...
const api = createApiClient({
  users: group({
    endpoints: {
      list: get<void, User[]>('/users'), // → https://api.example.com/users
    }
  }),
}, {
  baseUrl: 'https://api.example.com',
...
- [Error Handling](/error_handling) - Learn error types and strategies
- [Plugins](/plugins) - Extend with caching, retries, and more
- [Custom Handlers](/custom_handlers) - Handle special cases
- [Advanced Examples](/advanced_examples) - See real-world configurations
...
- [Basic Usage](/basic_usage) - Learn how to define and call endpoints
...
- [Error Handling](/error_handling) - Type-safe error management

Ready to build your first real API client? Let's dive into [Basic Usage](/basic_usage)!